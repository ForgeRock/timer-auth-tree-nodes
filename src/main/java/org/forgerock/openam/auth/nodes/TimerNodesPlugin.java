 ...
 */
public class TimerNodesPlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public TimerNodesPlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    protected Iterable<? extends Class<? extends Node>> getNodes() {
        return asList(
                TimerStartNode.class, TimerStopNode.class
        );
    }
}
